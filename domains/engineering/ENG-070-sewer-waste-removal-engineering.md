...
engineering problem from `ENG-080`'s water-supply side — different
...
challenge from `ENG-080`'s water-supply gradient problem, since a
...
millennium (following `ENG-080`'s own Roman-to-19th-century capability
...
night-soil removal, closer in logic to `AGR-110`'s manure-cycling
...
vice versa, with the specific disease-transmission consequence (`HLT-090`)
