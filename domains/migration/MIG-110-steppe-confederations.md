...
legacy_ref:
domain: migration
domains_touched: [war, diplomacy, agriculture]
tier: core
status: drafted
confidence: medium
date_start: -200
...
enables: [MIG-130]
see_also: [DIP-060, AGR-140, MIG-080]
contested: false
contested_note: ""
...
period, wherever the mobility preconditions (MIG-050, MIG-040) are already in
...
(MIG-050, MIG-040) plus proximity to a settled power worth mobilizing
