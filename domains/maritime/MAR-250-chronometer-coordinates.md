...
was solved by MAR-050's techniques centuries earlier; longitude (position
...
marine insurance risk premiums (MAR-120) and a corresponding increase in the
...
compounding with celestial latitude-finding (MAR-050) to give a navigator
