...
prereqs: [COM-140]
enables: [FIN-220]
see_also: [FIN-230, FIN-270]
contested: true
contested_note: "Whether the classical gold standard (roughly 1870s-1914) genuinely stabilized international trade and investment by providing credible, predictable exchange rates, or primarily transmitted deflationary shocks and constrained governments' ability to respond to domestic downturns (a major line of argument for why it worsened the Great Depression, see FIN-230), is debated among monetary historians. Model the gold standard as delivering real exchange-rate predictability benefits to international trade and capital flows while simultaneously removing a state's ability to use monetary policy countercyclically — both effects real and simultaneous, with the net verdict depending on which one matters more in a given crisis rather than one effect canceling the other out."
...
directly back to the silver-market dynamics COM-140 describes, leaves its
...
of why it deepened the Great Depression (FIN-230). Model both effects as
