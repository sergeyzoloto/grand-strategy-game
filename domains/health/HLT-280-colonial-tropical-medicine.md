...
id: HLT-280
former_ids: [HLT-034]
title: Colonial and Tropical Medicine
legacy_ref:
domain: health
...
whose primary institutional purpose is enabling and sustaining colonial
personnel's presence in a disease environment they have no evolved or
acquired resistance to, converting `medical efficacy` into a specific,
targeted enabler of territorial control rather than a general
...
The same medical apparatus serves two populations very unevenly:
colonizing personnel receive systematic prophylaxis and dedicated
hospital access specifically to sustain their own presence and labor
capacity, while local population health outcomes depend heavily on
whether a given colonial administration's specific interventions
(vaccination campaigns, water infrastructure) happened to have positive
local spillover — a genuine public health effect in some cases, entirely
absent in others, with the institution's own primary design purpose
never actually requiring the local benefit to occur at all.
...
How much colonial medical institutions genuinely improved local
population health, versus functioned almost entirely to protect
colonizing personnel and enable resource extraction, is disputed among
historians of colonial medicine, with real evidence for both a measurable
local public-health effect in some specific interventions and a
primarily extraction-enabling institutional purpose overall. Model
local-population health outcomes and colonizer health outcomes as two
separately tracked effects of the same institution rather than assuming
genuine local benefit follows automatically from the institution's
existence, or that its colonial function rules out any real local benefit
at all.
