...
enables: [WAR-330]
see_also: [MAR-340, WAR-270, WAR-110, MED-130, MAR-350, ENG-330, MED-030, MAR-335, ENG-340, NAT-250, DIP-055]
contested: false
contested_note: ""
...
nobody is watching, rather than merely slower. Warning also compresses the
time in which a false signal can be checked, so the same architecture that
buys interception makes a spurious alarm dangerous — the Soviet false alarm of
1983 turned on one officer's refusal to report it as an attack (DIP-055).
Radar development itself was
